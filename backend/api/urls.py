...
urlpatterns = [
    ...
    # Sector Urls
    path('sector/create', SectorView.as_view(), name='create_sector'),
    ...
    path(
        ...
        DeleteCitizensCharterPdfView.as_view(),
        name='delete_citizens_charter_pdfs'
    ),
    path(
    ...
    path(
        'filters/service',
        ServiceFiltersView.as_view(),
        name='fetch_service_filters'
    ),
    path(
